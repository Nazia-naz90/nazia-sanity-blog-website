...
return(
  ...
  <h3 className="font-bold text-2xl text-[#2d5474] mb-4">
Add a Comment
  </h3>
  ...
  <div className="space-y-4">
    ...
    className='border px-4 py-2 w-full rounded-md focus:ring-blue-500' 
    />
    <input
    type="email"
...
className='bg-[#4DA1A9] text-white px-4 py-2 
rounded-lg hover:bg-[#26767e]
transition
'>
...
<p className="text-gray-500 ">
    ...
    mb-4 border rounded-md bg-gray-100 transition
    ">
